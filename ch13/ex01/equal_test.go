...
func TestEqual(t *testing.T) {
	...
	for _, test := range []struct {
		...
		// LowerBound Equal
		{2.000000002, 2.000000004, false},
		{2.0000000002, 2.0000000004, true},
		{2.0000000000000000000000000000001, 2.0000000000000000000000000000000004, true},
		{0.000000000000000000000000000000000000000000001, 0.0000000000000000000000000000000000000000000000000003, true},
		{complex(2.000000002, 1), complex(2.000000004, 1), false},
		{complex(2.0000000002, 1), complex(2.0000000004, 1), true},
